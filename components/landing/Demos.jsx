            ...
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/1.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/2.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/3.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/4.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/5.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/6.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/8.png"
                    alt=""
                    width={400}
                    height={300}
                  />
          ...
          <div className="carddx">
            <div className="   items">
              <div className="item text-center mb-50">
                <div className="img mb-20">
                  <Image
                    src="/landing-preview/img/demos/7.png"
                    alt=""
                    width={400}
                    height={300}
                  />
